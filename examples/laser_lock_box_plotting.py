...
try:
	...
	i.set_local_oscillator(source='external', frequency=4e3, phase=0, pll_auto_acq = True)
	...
	i.set_pid_by_gain(2, g=0, kp=1, input_offset = 0.0)
	...
	i.set_monitor('A', 'error')
	i.set_monitor('B', 'scan') #green
