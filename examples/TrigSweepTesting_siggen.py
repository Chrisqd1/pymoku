...
i.set_trigger_source(ch = 1, TriggerSource = 'external')
i.set_trigger_source(ch = 2, TriggerSource = 'external')
...
i.set_trigger_source(ch = 1, TriggerSource = 'adc')
i.set_trigger_source(ch = 2, TriggerSource = 'adc')
input("\n Connect trigger to Moku ADC 1/2. Two 5 Hz cycles seen on channel 1/2 when triggered? Press enter to continue...")

# Test DAC trigger
i.set_trigger_source(ch = 1, TriggerSource = 'dac')
i.set_trigger_source(ch = 2, TriggerSource = 'dac')
...
i.set_trigger_source(ch = 1, TriggerSource = 'internal')
i.set_trigger_source(ch = 2, TriggerSource = 'internal')
i.set_trigger_mode(ch = 1, mode = 'gateway')
i.set_trigger_mode(ch = 2, mode = 'gateway')
i.gen_sinewave(1, 1.0, 5)
i.gen_sinewave(2, 1.0, 5)
...
# Test Ext Trig IN
i.set_trigger_mode(ch = 1, mode = 'ncycle', SignalFreq = 5.0, NCycles = 1)
i.set_trigger_mode(ch = 2, mode = 'ncycle', SignalFreq = 5.0, NCycles = 1)
i.set_trigger_source(ch = 1, TriggerSource = 'external')
i.set_trigger_source(ch = 2, TriggerSource = 'external')
...
# NCycle mode, 200 Hz:
i.set_trigger_mode(ch = 1, mode = 'ncycle', SignalFreq = 200.0, NCycles = 1)
i.set_trigger_mode(ch = 2, mode = 'ncycle', SignalFreq = 200.0, NCycles = 1)
...
# NCycle mode, 2 KHz:
i.set_trigger_mode(ch = 1, mode = 'ncycle', SignalFreq = 2000.0, NCycles = 1)
i.set_trigger_mode(ch = 2, mode = 'ncycle', SignalFreq = 2000.0, NCycles = 1)
...
# NCycle mode, 2 MHz:
i.set_trigger_mode(ch = 1, mode = 'ncycle', SignalFreq = 2.0e6, NCycles = 1)
i.set_trigger_mode(ch = 2, mode = 'ncycle', SignalFreq = 2.0e6, NCycles = 1)
...
i.set_trigger_source(ch = 1, TriggerSource = 'external')
i.set_trigger_source(ch = 2, TriggerSource = 'external')
i.set_trigger_mode(ch = 1, mode = 'sweep', SweepInitFreq = 1.0, SweepFinalFreq = 5.0, SweepDuration = 10.0)
i.set_trigger_mode(ch = 2, mode = 'sweep', SweepInitFreq = 1.0, SweepFinalFreq = 5.0, SweepDuration = 10.0)
...
i.set_trigger_mode(ch = 1, mode = 'sweep', SweepInitFreq = 50.0, SweepFinalFreq = 1000.0, SweepDuration = 10.0)
input("\n Sweep from 50 Hz to 1 KHz over 10 seconds seen on channel 1? Press enter to continue ... ")

i.set_trigger_source(ch = 1, TriggerSource = 'external')
i.gen_sinewave(1, 1.0, 10)
i.set_trigger_mode(ch = 1, mode = 'sweep', SweepInitFreq = 100.0e3, SweepFinalFreq = 1.0e6, SweepDuration = 10.0)
input("\n Sweep from 100 KHz to 1 MHz over 10 seconds seen on channel 1? Press enter to continue ... ")

i.set_trigger_source(ch = 1, TriggerSource = 'external')
i.gen_sinewave(1, 1.0, 10)
i.set_trigger_mode(ch = 1, mode = 'sweep', SweepInitFreq = 1.0e6, SweepFinalFreq = 50.0e6, SweepDuration = 10.0)
...
i.set_trigger_source(ch=1, TriggerSource = 'external')
i.set_trigger_mode(ch = 1, mode = 'ncycle', SignalFreq = 10.0e6, NCycles = 1)
#i.set_mode(ch = 1, mode = 'sweep', SweepInitFreq = 1.0, SweepFinalFreq = 5.0, SweepDuration = 10.0)
