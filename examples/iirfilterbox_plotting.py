...
"""
This script provides a basic example showing how to load coefficients from an array into the IIRFilterBox and how to set up oscilloscope probes to monitor time domain 
signals at different points in the instrument.
